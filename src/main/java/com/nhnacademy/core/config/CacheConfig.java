...
public class CacheConfig {
    ...
    public Cache<String, RoomSensorMetricSnapshots.SummarySnapshot> summarySnapshotLocalCache(
    ...
    public Cache<String, RoomSensorMetricSnapshots.LatestSnapshot> latestSnapshotLocalCache(
            SensorMetricSnapshotCacheProperties properties
    ) {
        return Caffeine.newBuilder()
                .maximumSize(properties.maximumSizePerType())
